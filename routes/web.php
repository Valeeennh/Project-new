...
use App\Http\Livewire\Addcompany;
...
Route::get('employe', Index2::class);
Route::get('editdepartment', Editdepartment::class);
Route::get('department', Index4::class);
Route::get('company', Index5::class);
...
Route::get('editcompany',Editcompany::class);
// ROUTE USE
