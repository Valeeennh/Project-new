                            ...
                            <div class="row">
                                <div class="col-20 col-sm-20">
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex">
                                            <div class="ms-auto">
                                                <a href="javascript:void(0);" class="btn btn-sm btn-success">Tambah</a>
                                            </div>
                                        </div>

                                        <form class="form-horizontal">
                                            <h6 class="text-uppercase fw-semibold mb-3">Add Company</h6>
                                            <div class="form-group">
                                                <div class="row row-sm">
                                                    <div class="col-md-3">
                                                        <label class="form-label fw-semibold text-muted-dark">Nama Company</label>
                                                    </div>
                                                    <div class="col-md-9">
                                            ...
                                            <div class="form-group ">
                                                <div class="row row-sm">
                                                    <div class="col-md-3">
                                                        <label class="form-label fw-semibold text-muted-dark">Deskripsi</label>
                                                    </div>
                                                    <div class="col-md-9">
                                                        <input type="text" class="form-control"
                                            ...
                                            <div class="form-group ">
                                                <div class="row row-sm">
                                                    <div class="col-md-3">
                                                        <label class="form-label fw-semibold text-muted-dark">Time start</label>
                                                    </div>
                                                    <div class="col-md-9">
                                            ...
                                            <div class="form-group ">
                                                <div class="row row-sm">
                                                    <div class="col-md-3">
                                                        <label class="form-label fw-semibold text-muted-dark">Time end</label>
                                                    </div>
                                                    <div class="col-md-9">
                                                        <select class="form-select select2" id="validationCustom04" required>
                                                            <option selected disabled value="">Choose...</option>
                                            ...
                                            <div class="form-group ">
                                                <div class="row row-sm">
                                                    <div class="col-md-3">
                                                        <label class="form-label fw-semibold text-muted-dark">Work time</label>
                                                    </div>
                                                    <div class="col-md-9">
                                                        <select class="form-select select2" id="validationCustom04" required>
                                                            <option selected disabled value="">Choose...</option>
