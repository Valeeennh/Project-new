											...
											<div class="tab-menu-heading p-0 pb-2 border-0">
												<div class="tabs-menu">
													...
													<ul class="nav panel-tabs">
														...
														<li><a href="#side2" data-bs-toggle="tab" ><i class="fe fe-message-square"></i><p>Absensi</p></a></li>
														<li><a href="#side3" data-bs-toggle="tab"><i class="fe fe-calendar"></i><p>data pegawai</p></a></li>
